"""
Django settings for Pokidex project.
...
SECRET_KEY = '(8qwdnv$=3!=zy1mfzg+y_*fm!6*51&ob79h7$=stok&a#%ka$'
...
ROOT_URLCONF = 'Pokidex.urls'

WSGI_APPLICATION = 'Pokidex.wsgi.application'
